...
public class JunitUserDaoTest {
  ...
  public void setUp()throws Exception{
	  ...
	  user01=new UserVO("p05", "김무엘05", "4321",Level.BASIC,1,0,"rlatkandpf30@naver.com","날짜_사용않안함");
  ...
  public void doUpdate() throws SQLException {
	  ...
	  vsVO.setName(vsVO.getName()+upStr);
	  vsVO.setPasswd(vsVO.getPasswd()+upStr);
	  vsVO.setEmail(vsVO.getEmail()+upStr);
	  
	  vsVO.setLogin(vsVO.getLogin()+upInt);
	  vsVO.setRecommend(vsVO.getRecommend()+upInt);
	  vsVO.setLevel(Level.SILVER);
	  
	  //5.
	  dao.doUpdate(vsVO);
	  
	  //6.
	  UserVO resultVO = dao.doSelectOne(vsVO);
	  isSameUser(vsVO, resultVO);
