  ...
  <div class="container">
    ...
    <div class="row text-right">
      ...
      <div class="col-sm-9 col-md-10 col-lg-10">
        <input type="button" class="btn btn-primary btn-sm" value="목록" /> <input
          type="button" class="btn btn-primary btn-sm" value="등록" />
      </div>
    </div>
    <!--// 버튼  ---------------------------------------------------------------->
    ...
    <form action="" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-9 col-md-10 col-lg-10">
          <input type="text" maxlength="100" name="title" id="title"
            placeholder="제목" class="form-control">
        </div>
      </div>

      <div class="form-group">
        <label for="div" class="col-sm-3 col-md-2 col-lg-2 ">구분</label>
        <div class="col-sm-9 col-md-10 col-lg-10">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9 col-md-10 col-lg-10">
          <input type="text" maxlength="100" name="regId" id="regId"
            placeholder="등록자" class="form-control">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9 col-md-10 col-lg-10">
          <textarea rows="5" cols="20" name="contents" id="contents"
