<%--
/**
  Class Name: boot_list.jsp
  Description: 부트스트랩 리스트
      ...
      <table class="table table-striped table-bordered table-hover table-condensed">
       ...
       <!-- 문자: 왼쪽, 숫자:오른쪽, 같은면: 중앙 -->
         <tr>
           ...
           <td class="text-center col-sm-1 col-md-1 col-lg-1">이상무</td>
           <td class="text-center col-sm-2 col-md-2 col-lg-1">2022-05-24</td>
           <td class="text-right col-sm-2 col-md-2 col-lg-1">0</td>
         </tr>
         <tr>
